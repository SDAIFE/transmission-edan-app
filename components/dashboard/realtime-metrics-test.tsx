        ...
        <CardContent>
          <div className="grid gap-4 md:grid-cols-4">
            <div className="flex items-center space-x-2">
              ...
              <Badge variant="outline">{mockRealtimeMetrics.departements.totalDepartements}</Badge>
            </div>
            <div className="flex items-center space-x-2">
              <CheckCircle className="h-4 w-4 text-green-600" />
              <span className="text-sm font-medium">Publiés</span>
              <Badge variant="secondary" className="bg-green-100 text-green-800">
                {mockRealtimeMetrics.departements.departementsPubliés}
              </Badge>
            </div>
            <div className="flex items-center space-x-2">
              ...
              <Badge variant="secondary" className="bg-yellow-100 text-yellow-800">
                {mockRealtimeMetrics.departements.departementsEnAttente}
              </Badge>
            </div>
            <div className="flex items-center space-x-2">
              ...
              <Badge variant="secondary" className="bg-purple-100 text-purple-800">
                {mockRealtimeMetrics.departements.tauxPublication.toFixed(1)}%
              </Badge>
            </div>
          </div>
        </CardContent>
